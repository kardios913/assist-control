  ...
  <div>
    <div v-if="action === 'LISTAR'">
      ...
      <b-card style="background-color: #f0f2f6 !important;">
        ...
        <b-btn variant="danger" class="float-right" @click="action = 'REGISTRAR'">Registrar</b-btn>
      </b-card>
    </div>
    <div v-else>
...
export default {
  ...
  data () {
    return {
      classForCols: 'my-1',
      classInsideCols: 'b-2 py-1 pl-2 mx-1 shadow-sm bg-white rounded full-height',
      persona: {
        nombre: '',
        apellido: '',
        email: '',
